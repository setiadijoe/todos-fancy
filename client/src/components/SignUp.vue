<template>
  <div class="panel">
    <p class="texto">Sign Up</p>
      <div class="Registro">
      <span class="fontawesome-user"></span><input type="text" required placeholder="Your Real Name" autocomplete="off" v-model="signup.name"> 
      <span class="fontawesome-envelope-alt"></span><input type="text" required placeholder="Your username" autocomplete="off" v-model="signup.username">
      <span class="fontawesome-lock"></span><input type="password" required placeholder="Your password" autocomplete="off" v-model="signup.password"> 
